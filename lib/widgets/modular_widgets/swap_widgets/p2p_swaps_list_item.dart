...
import 'package:zenon_syrius_wallet_flutter/widgets/reusable_widgets/dialogs/swap_dialogs/old/unlock_dialog.dart';
...
class _P2pSwapsListItemState extends State<P2pSwapsListItem> {
  ...
  String _getPreimage() {
    ...
    for (int i = 0; i < activeSwapsBox.length; i++) {
      String? preimage = activeSwapsBox.getAt(i)['preimage'];
      if (preimage != null &&
          preimage.isNotEmpty &&
          Hash.parse(preimage) == Hash.fromBytes(widget.htlcInfo!.hashLock)) {
        //TODO: Test this
        return preimage;
      }
    }
